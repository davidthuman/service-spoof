...
> [!IMPORTANT]  
> This project was developed with the use of an integrated AI-assist (specifically Claude Code). As this project was on sitting my backlog, I decided to test out development with integrated AI-assistance (as opposed to chat-based research or code-gen). Code generated by Claude Code will have the commit author of that name, and will be separate from any human generated code or edits.
